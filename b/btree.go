...
func (t *Tree) First() (k float64, v struct{}) {
	if q := t.first; q != nil {
		q := &q.d[0]
		k, v = q.k, q.v
	}
...
func (t *Tree) Get(k float64) (v struct{}, ok bool) {
	q := t.r
	if q == nil {
		return
	}
...
func (t *Tree) insert(q *d, i int, k float64, v struct{}) *d {
	t.ver++
	c := q.c
	if i < c {
...
// (zero-value, zero-value) if the tree is empty.
func (t *Tree) Last() (k float64, v struct{}) {
	if q := t.last; q != nil {
		q := &q.d[q.c-1]
		k, v = q.k, q.v
	}
...
func (t *Tree) overflow(p *x, q *d, pi, i int, k float64, v struct{}) {
	t.ver++
	l, r := p.siblings(pi)
...
func (t *Tree) Set(k float64, v struct{}) {
	//dbg("--- PRE Set(%v, %v)\n%s", k, v, t.dump())
	//defer func() {
	//	dbg("--- POST\n%s\n====\n", t.dump())
	//}()
...
func (t *Tree) Put(k float64, upd func(oldV struct{}, exists bool) (newV struct{}, write bool)) (oldV struct{}, written bool) {
	pi := -1
	var p *x
	q := t.r
	var newV struct{}
...
func (t *Tree) split(p *x, q *d, pi, i int, k float64, v struct{}) {
	t.ver++
	r := btDPool.Get().(*d)
	if q.n != nil {
		r.n = q.n
...
// io.EOF is returned.
func (e *Enumerator) Next() (k float64, v struct{}, err error) {
...
// == io.EOF is returned.
func (e *Enumerator) Prev() (k float64, v struct{}, err error) {
	if err = e.err; err != nil {
		return
	}
